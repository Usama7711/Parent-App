            ...
            <div className="Assignments ">
              <div className="head">
                ...
                <p className="ViewAll"
                  ...
                  style={{ cursor: 'pointer' }} ><Link to="/Assignment"> View All</Link></p>
              </div>
                ...
                <table className="assignment-custom-table">
                  <thead>
                    <tr>
                      ...
                      <th className="w30 titleAssisment">Title</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td >Geography</td>
                      <td className="titleAssisment">Earth's surface and the Plane Surface</td>
                      <td >20-02-2023</td>
                      <td >
                        <span className="approved">Approved</span>
                      </td>
          ...
          <div className="col-xl-4 mt-0 paddingLeft10">
            <div className="NoticeBoard ">
              <div className="head">
                ...
                <p className="ViewAll"><Link to="/NoticeBoard">View All</Link></p>
              </div>
        ...
        <div className="top_section_2">
          <div className="Assignments col-xl-8">
            <div className="head">
              ...
              <p className="ViewAll"><Link to="/Assessment">View All</Link></p>
            </div>
            <div className="tabel-main-wrpper">
              <table>
                <thead>
        ...
        <div className="top_section_2">
          <div className="Assignments col-xl-8">
            <div className="head">
              ...
              <p className="ViewAll"><Link to="/Courses">View All</Link></p>
            </div>
            <div className="tabel-main-wrpper">
              <table>
                <thead>
        ...
        <div className="top_section_2">
          <div className="Assignments col-xl-8">
            <div className="head">
              ...
              <p className="ViewAll"><Link to="/Fees">View All</Link></p>
            </div>
            <div className="tabel-main-wrpper">
              <table>
                <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="titleAssisment">Mr. Harvard</td>
                    <td>29-02-2023</td>
                    <td className="">
                      <span className="approved same-width">paid</span>
                    </td>
