  ...
  return (
    <main id="cx-main" className="Dashboard">
      ...
      >
        <SubHeader />
        <div
          className="mydiary_wrapper mydiary_wrapper2"
          data-aos="zoom-in"
          data-aos-duration="500"
          id="cx-wrapper"
        >
              ...
              <Tab.Container id="left-tabs-example" defaultActiveKey="0">
                <div className="row g-0">
                  <div className="col-lg-4">
                    <div className="mydiary-list-wrapper mydiary-list-wrapper2">
                  ...
                  <div className="col-lg-8">
                    <div className="mydiary-detail-wrapper mydiary-detail-wrapper2">
                      <Tab.Content>
                        <Tab.Pane eventKey="0">
                            ...
                            <div className="main-diary-details-wrapper">
                              ...
                              <div className="md-text-box">
                                <p>
                                  ...
                                  the years. It has a more-or-less normal
